...
public class LoginViewControler {
    ...
    void iniciarSesion(ActionEvent event) {
        ...
        if (esAdministrador(usuario, password)) {
            ...
            JOptionPane.showMessageDialog(null, "Inicio de sesión correcto para Administrador", "Éxito", JOptionPane.INFORMATION_MESSAGE);

        } else if (esVendedor(usuario, password)) {
            // Las credenciales corresponden a un vendedor, puedes abrir la ventana del vendedor
            JOptionPane.showMessageDialog(null, "Inicio de sesión correcto para Vendedor", "Éxito", JOptionPane.INFORMATION_MESSAGE);
